    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-4">
        ...
        <div class="flex items-center justify-between">
            <label for="remember_me" class="flex items-center gap-2">
                <input id="remember_me" type="checkbox" name="remember" class="rounded border-gray-300 text-gray-600 focus:ring-green-500">
        ...
        {{-- Submit --}}
        <button type="submit" class="w-full py-3 bg-phekong text-white rounded-lg font-medium text-base hover:bg-phekong-dark transition">
            Log in
        </button>
    </form>
</x-guest-layout>