<x-app-layout>
    ...
    <div class="py-6 max-w-6xl mx-auto sm:px-6 lg:px-8">
        ...
        @if (auth()->user()->hasRole('stock_admin'))
            <a href="{{ route('sales.dashboard') }}" class="px-4 py-2 bg-indigo-600 text-white rounded text-sm">Sales
                Dashboard</a>
        ...
        @auth
            ...
            @if (auth()->user()->hasRole('approval_admin'))
                <a href="{{ route('stock-requests.index') }}"
                    class="inline-block mb-4 ml-2 px-4 py-2 bg-yellow-600 text-white rounded">
        ...
        @if (auth()->user()->hasRole('stock_admin'))
            <a href="{{ route('sales.index') }}"
                class="inline-block mb-4 ml-2 px-4 py-2 bg-green-600 text-white rounded">
                Sales Report
            </a>
        @endif
